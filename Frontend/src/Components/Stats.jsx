...
function Stats() {
  return (
    <div
      className="mx-auto p-4 border-[1px] border-white text-white flex flex-wrap  gap-4 sm:gap-8 rounded-lg"
      style={{
        background: 'linear-gradient(90deg, hsla(275, 100%, 50%, 1) 0%, hsla(207, 68%, 50%, 1) 100%)',
      }}
    >
      {/* Registration Stats */}
      <div id="Stats1" className="border-r-2 border-white pr-3 flex flex-col items-center sm:items-start">
      ...
      {/* Events Stats */}
      <div id="Stats2" className="border-r-2 border-white pr-3 flex flex-col items-center sm:items-start">
