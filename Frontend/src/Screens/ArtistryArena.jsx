        ...
        <div className='flex flex-col items-start justify-center'>
          <div className='font-Montserrat flex flex-col gap-3 relative px-10 md:px-20 py-10 md:py-20'>
            ...
            <div id='groupButton' className='flex flex-col md:flex-row gap-3'>
              ...
              <button onClick={()=>navigate("/contact")} className='flex justify-center items-center bg-transparent border-[1px] border-white rounded-md px-6 py-2 font-semibold hover:bg-slate-50 hover:text-gray-950 transition duration-300 ease-in-out'>Contact us</button>            </div>
          </div>
        </div>
      </div>
      {/* Page Hero Closed */}
