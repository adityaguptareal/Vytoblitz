...
function Hackathon() {
  ...
  const data = {
    ...
    image3: Images.Hackathon3,
    image4: Images.Hackathon4
    ...
    <div className='bg-gray-950'>
      ...
      <div className='px-10 md:px-20 lg:px-40 py-10 text-white font-Montserrat'>
        ...
        <ul className='list-disc list-inside'>
          ...
          <li className='mb-3'><strong>11:45 AM - 1:00 PM:</strong> Coding Round</li>
          <li className='mb-3'><strong>1:00 PM - 2:00 PM:</strong> Lunch Break</li>
          <li className='mb-3'><strong>2:00 PM - 3:30 PM:</strong> Final Round</li>
          <li className='mb-3'><strong>3:30 PM - 4:00 PM:</strong> Closing and Awards</li>
        </ul>
      </div>
